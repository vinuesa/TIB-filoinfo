...
- [práctica - split_fasta.pl](https://github.com/vinuesa/TIB-filoinfo/bin/split_fasta.pl)
- [práctica - blast-imager.pl](https://github.com/vinuesa/TIB-filoinfo/bin/blast-imager.pl)
- Lecturas recomendadas
